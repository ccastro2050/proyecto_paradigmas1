...
| Cosa | Convención |
|---|---|
| Puertos públicos | front 8000 · · api_facturas 8002 · phpMyAdmin 8081 |
...
| Hosts internos (entre contenedores) | `postgres:5432` · `mariadb:3306` · `sqlserver:1433` · `api-facturas:8002` |
