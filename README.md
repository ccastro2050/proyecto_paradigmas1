...
> el puerto 8002 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                 STATUS                    PORTS
> proyecto_paradigmas1-api-facturas-1   Up 2 hours                0.0.0.0:8002->8002/tcp
> proyecto_paradigmas1-postgres-1       Up 2 hours (healthy)      0.0.0.0:15432->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_paradigmas1.git
cd proyecto_paradigmas1
